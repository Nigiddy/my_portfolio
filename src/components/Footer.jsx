      ...
      <div className="w-full mx-auto px-6 sm:px-8 max-w-5xl">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-8 mb-12">
          ...
          <div className="flex flex-col gap-4">
            <div>
              ...
              <p className="text-sm text-gray-500 mt-1">Building interfaces that feel inevitable.</p>
            </div>
            <div className="flex items-center gap-4 text-gray-400">
              <a href="#" className="hover:text-gray-900 transition-colors" aria-label="GitHub"><Github className="w-[18px] h-[18px]" /></a>
              <a href="#" className="hover:text-gray-900 transition-colors" aria-label="LinkedIn"><Linkedin className="w-[18px] h-[18px]" /></a>
              <a href="#" className="hover:text-gray-900 transition-colors" aria-label="Twitter"><Twitter className="w-[18px] h-[18px]" /></a>
          ...
          <div className="flex flex-col gap-3">
            <h3 className="text-gray-900 font-semibold text-sm">Navigation</h3>
          ...
          {/* Column 3: Status */}
          <div className="flex flex-col gap-3">
            <h3 className="text-gray-900 font-semibold text-sm">Status</h3>
        ...
        <div className="pt-6 border-t border-gray-200 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-xs font-mono text-gray-400 tabular-nums">
            © {year} Gideon Papa — Designed &amp; built with Next.js and Tailwind CSS
          </p>
        </div>
      </div>
    </footer>
